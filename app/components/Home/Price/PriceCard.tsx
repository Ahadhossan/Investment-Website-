...
const PriceCard = ({bg, days, maxInvest, minInvest, percentage}: Props) => {
  return (
    <div className={`${bg} p-6 text-center rounded-lg`}>
      <h1 className="text-[17px] font-bold md:text-[20px] text-white mt-8">
        After {days} days
      </h1>
      <h1 className="w-[90%] mx-auto bg-orange-600 text-white text-[23px] font-bold p-4 rounded-lg mt-6">
        {percentage}%
      </h1>
